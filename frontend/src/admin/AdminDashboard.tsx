...
export default function AdminDashboard() {
  ...
  const handleRemoveFromRegistry = async () => {
    ...
    try {
      ...
      setError(removeError instanceof Error ? removeError.message : 'We could not remove this plugin from the registry.');
    } finally {
      setBusy(false);
    }
  };
