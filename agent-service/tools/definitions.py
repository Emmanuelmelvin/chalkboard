...
TOOL_SPECS: list[tuple[str, str, list[tuple[str, str, bool]]]] = [
    ...
    ("chalkboard_insert_shape",
     "Inserts one geometric shape at canvas coordinate (x,y). One shape per call. radius controls its size (default 80 canvas units); use color, size, intensity, and fillColor to match the board.",
