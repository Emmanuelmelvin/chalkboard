...
export const tagManifest: PluginManifest = {
  ...
  contributes: {
    ...
    selectionTools: [
      ...
      { id: 'tag.edit-selection', label: 'Edit Tag', description: 'Edit the tag attached to the selected object.', command: 'tag.editSelection' },
      { id: 'tag.remove-selection', label: 'Remove Tag', description: 'Remove the tag attached to the selected object.', command: 'tag.removeSelection' },
    ],
  },
};
